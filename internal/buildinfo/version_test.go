...
func TestResolve(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "release injection", configured: "0.2.0", info: dirty, want: "0.2.0"},
		{name: "Nix development injection", configured: "0.2.0-dev.abcdef012345.dirty", info: clean, want: "0.2.0-dev.abcdef012345.dirty"},
	}
